...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_tavil_old.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_tavil_old.xml \
...
# Inherit vendor
$(call inherit-product, vendor/samsung/d2xq/d2xq-vendor.mk)